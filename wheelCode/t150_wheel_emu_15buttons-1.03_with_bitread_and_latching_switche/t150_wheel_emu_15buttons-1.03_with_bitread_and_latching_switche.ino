...
void loop() {
  ...
  up = bitRead(pin_c, 1);
  down = bitRead(pin_c, 5);
  left = bitRead(pin_c, 2);
  right = bitRead(pin_c, 3);
...
//  
  ...
  wheelState[2] = ((PINB & B00000011) << 6) | (pin_c & B00111111); // take bits 0,1 from PORTB + bits 0-5 from PORTC
